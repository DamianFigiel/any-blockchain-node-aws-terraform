chain             = "enjin"
node_docker_image = "enjin/relaychain:latest" #if you plan to use it for production, please use specfic image version, not latest, to avoid unintended version updates
